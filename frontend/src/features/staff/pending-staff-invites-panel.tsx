          ...
          {inviteCards.map((invite) => (
            ...
            >
              ...
              <button
                ...
                className="mt-4 inline-flex rounded-full bg-accent px-5 py-3 text-sm font-semibold text-white transition hover:bg-accent-strong disabled:cursor-not-allowed disabled:opacity-65"
              >
